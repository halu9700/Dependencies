...
namespace Dependencies
{
    ...
    class PeDependencyItem : IPrettyPrintable
    {
        ...
        public void ResolveDependencies()
        {
            Action action = () =>
            {
                ...
                {
                    if (Dep.SearchStrategy == ModuleSearchStrategy.ApiSetSchema || Dep.SearchStrategy == ModuleSearchStrategy.WellKnownDlls)
                        continue;
                    Dep.LoadPe();
    ...
    {
		public PeDependencies(PE Application,List<string> customSearchFolders, int recursion_depth)
        {
        ...
        private List<string> customSearchFolders;
    }
